    ...
    <section className="container mx-auto w-11/12 py-10">
      ...
      >
        ...
        <div className="flex gap-8 rtl:flex-row-reverse">
          <div className="relative before:pointer-events-none before:absolute before:left-0 before:-z-10 before:h-[22.5rem] before:w-[16.875rem] before:rotate-3 before:rounded-[3.125rem_7.5rem_7.5rem_7.5rem] before:border-4 before:border-maroon-600 before:content-[''] dark:before:border-softpink-400">
            <Image
        ...
        <div className="flex flex-col">
          <h2 className="mb-6 text-xl font-bold text-softpink-500 dark:text-maroon-400">
            {t('title')}
          </h2>
