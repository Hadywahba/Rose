  ...
  return (
    <div className={`relative w-full ${className ?? ''}`}>
      ...
      <input
        ...
        className="dark:focus:ring-soft-pink-200 w-full rounded-xl border border-zinc-200 py-2.5 pl-9 pr-8 text-sm outline-none transition-all focus:ring-2 focus:ring-maroon-700 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100"
      />
